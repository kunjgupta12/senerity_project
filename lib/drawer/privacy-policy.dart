        ...
        child: Stack(
          children: [
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(526.5*fem, 0*fem, 525.5*fem, 7*fem),
                      width: double.infinity,
                      height: 67*fem,
                      decoration: BoxDecoration (
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(566*fem, 0*fem, 566*fem, 5*fem),
                            width: double.infinity,
                            height: 148*fem,
                            child: Stack(
                              children: [
                          ...
                          Container(
                            ...
                            child: RichText(
                              ...
                              text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text: 'For more detailed information, please read our complete Privacy Policy ',
                                  ),
                                  TextSpan(
                                    text: 'linked',
                                    style: SafeGoogleFont (
                                  ...
                                  TextSpan(
                                    text: '. It’s important to be informed about your data rights and how we protect your privacy.\n',
                                  ),
                                ],
                              ),
                            ),
            ...
            Positioned(
              ...
              top: 724*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(34*fem, 13*fem, 33*fem, 13*fem),
                width: 360*fem,
                height: 76*fem,
                decoration: BoxDecoration (
                  ...
                  children: [
                    Container(
                      ...
                      child: TextButton(
                        ...
                        child: Container(
                          padding: EdgeInsets.fromLTRB(18*fem, 8*fem, 18*fem, 7.92*fem),
                          height: double.infinity,
                          child: Center(
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(16*fem, 8*fem, 27.92*fem, 7.92*fem),
                      height: double.infinity,
                      decoration: BoxDecoration (
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(21*fem, 8*fem, 22.92*fem, 7.92*fem),
                      height: double.infinity,
                      decoration: BoxDecoration (
                        image: DecorationImage (
                          fit: BoxFit.cover,
